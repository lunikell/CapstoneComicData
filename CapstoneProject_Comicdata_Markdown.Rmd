...
``` {r plotCramerV, fig.align = 'center', fig.asp = 0.8, out.width = "100%",fig.pos = "H", message = FALSE, warnings = FALSE, fig.cap= 'Results of Cramers V analysis of categorical variables in the train dataframe'}
association_matrix %>%
...
``` {r plotcp, fig.align = 'center', fig.asp = 0.55, out.width = "100%",  message = FALSE, warnings = FALSE, fig.cap= 'Results of the optimization of $c_p$'}
